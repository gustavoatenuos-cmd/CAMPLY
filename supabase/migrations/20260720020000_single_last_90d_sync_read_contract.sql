-- Single operational Meta sync contract. Meta sync writes the official last_90d daily base; Dashboard and Analytics only read date slices covered by that base.
