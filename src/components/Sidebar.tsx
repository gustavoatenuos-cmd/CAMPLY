...
export function Sidebar({ activeView, setActiveView, alertCount, onSignOut }: SidebarProps) {
  return (
    <aside className="relative z-40 flex w-full shrink-0 flex-col border-b border-brand-line bg-brand-surface/50 backdrop-blur-xl xl:h-screen xl:w-72 xl:border-b-0 xl:border-r">
