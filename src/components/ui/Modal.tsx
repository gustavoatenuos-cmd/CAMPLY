...
export function Modal({ title, description, open, onClose, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 p-4">
      <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-2xl border border-brand-line bg-brand-ink shadow-brand">
        <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-brand-line bg-brand-ink p-5">
          <div>
