...
export const metaE2EWorkspace: CamplyData = {
  clients: [{
    ...
    id: 'client-delivery-e2e',
    projectId: '',
    name: 'Delivery Mock',
    company: 'Delivery Mock',
    segment: 'Alimentação',
    structure: 'Pedidos pelo site',
    hasProject: false,
    contact: 'delivery@camply.test',
    monthlyFee: 1200,
    managementFeeType: 'recurring',
    dueDay: 10,
    adInvestmentPeriod: 'weekly',
    adInvestmentMeta: 700,
    adInvestmentGoogle: 0,
    adInvestmentYoutube: 0,
    adInvestmentTikTok: 0,
    status: 'active',
    notes: 'Fixture determinística de delivery.',
  }, {
    id: 'client-shoes-e2e',
    projectId: '',
    name: 'Loja de Calçados Mock',
    company: 'Loja de Calçados Mock',
    segment: 'Varejo local',
    structure: 'Loja física',
    hasProject: false,
    contact: 'calcados@camply.test',
    monthlyFee: 1400,
    managementFeeType: 'recurring',
    dueDay: 10,
    adInvestmentPeriod: 'monthly',
    adInvestmentMeta: 2400,
    adInvestmentGoogle: 0,
    adInvestmentYoutube: 0,
    adInvestmentTikTok: 0,
    status: 'active',
    notes: 'Fixture determinística de varejo.',
  }, {
    id: 'client-products-e2e',
    projectId: '',
    name: 'Loja de Produtos Mock',
    company: 'Loja de Produtos Mock',
    segment: 'Varejo local',
    structure: 'Varejo híbrido',
    hasProject: false,
    contact: 'produtos@camply.test',
    monthlyFee: 1600,
    managementFeeType: 'recurring',
    dueDay: 10,
    adInvestmentPeriod: 'monthly',
    adInvestmentMeta: 3200,
    adInvestmentGoogle: 0,
    adInvestmentYoutube: 0,
    adInvestmentTikTok: 0,
    status: 'active',
    notes: 'Fixture determinística de produtos.',
  }],
  campaigns: [],
  receivables: [],
  projects: [],
