...
export async function loadGlobalPerformanceDashboard(options: {
  ...
  if (isMetaE2EMode) {
    ...
    const campaignMetrics = {
      spend: e2eMetric('spend', 350, 'campaign', { campaignId: 'campaign-active-e2e' }),
      impressions: e2eMetric('impressions', 12000, 'campaign', { campaignId: 'campaign-active-e2e' }),
      reach: e2eMetric('reach', 6000, 'campaign', { campaignId: 'campaign-active-e2e' }),
      frequency: e2eMetric('frequency', 2, 'campaign', { campaignId: 'campaign-active-e2e' }),
      cpm: e2eMetric('cpm', 29.1667, 'campaign', { campaignId: 'campaign-active-e2e' }),
      link_clicks: e2eMetric('link_clicks', 420, 'campaign', { campaignId: 'campaign-active-e2e' }),
      landing_page_views: e2eMetric('landing_page_views', 310, 'campaign', { campaignId: 'campaign-active-e2e' }),
      messaging_conversations_started_total: e2eMetric('messaging_conversations_started_total', 28, 'campaign', { campaignId: 'campaign-active-e2e' }),
      leads: e2eMetric('leads', 16, 'campaign', { campaignId: 'campaign-active-e2e' }),
      purchases: e2eMetric('purchases', 3, 'campaign', { campaignId: 'campaign-active-e2e' }),
      purchase_value: e2eMetric('purchase_value', 1400, 'campaign', { campaignId: 'campaign-active-e2e' }),
      purchase_roas: e2eMetric('purchase_roas', 4, 'campaign', { campaignId: 'campaign-active-e2e' }),
    };
