        ...
        <div className="min-h-full">
          <ErrorBoundary key={activeView} viewName={activeView}>
            <Suspense fallback={<div className="flex h-full items-center justify-center text-brand-soft">Carregando tela...</div>}>
              ...
              {activeView === 'campaigns' ? <CampaignsView data={workspace.data} updateData={workspace.updateData} onOpenMetaIntegration={() => setActiveView('metaIntegration')} /> : null}
              ...
              {activeView === 'mediaFinance' ? <FinanceView data={workspace.data} updateData={workspace.updateData} /> : null}
              ...
              {activeView === 'intelligence' ? <IntelligenceView data={workspace.data} updateData={workspace.updateData} /> : null}
